...
public class PineappleMaterials extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PineappleMaterials frame = new PineappleMaterials();
	...
	public PineappleMaterials() {
		...
		JLabel lblNewLabel = new JLabel("產品結構 (鳳梨酥)");
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int inner = dao.getWeightOf(String.valueOf(list.get(6)));
		...
		JLabel label_3 = new JLabel("鳳梨餡 (200 克/盒)：");
		...
		textField_5.setText(String.valueOf(dao.getWeightOf(list.get(6))));
		...
		button_2.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(temp != 0){
					...
					//處理庫存
					int originQty = (int)Udao.getPineappleQty();
					int addedQty = Integer.parseInt(textField.getText())*12;
					originQty = originQty + addedQty;
					
					dao.setInventoryQty(originQty, "P001");
					
					
					//處理剩餘存貨
					int innerWeight = dao.getWeightOf(list.get(6));
